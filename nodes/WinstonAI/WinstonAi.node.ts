				...
				options: [
					{
						...
						description:
							'Analyze text to detect AI-generated content. The Human Score we give is a metric used by Winston AI to estimate the likelihood that a given piece of content was generated by an AI tool versus being written by a human.',
						routing: {
							request: {
								method: 'POST',
